...
import { ClipboardList, CreditCard, Smartphone, ShieldCheck, Truck, Wrench as MechanicIcon, TrendingUp, History, Percent, IdCard } from "lucide-react";
...
const CARDS: ReportCard[] = [
  ...
  { slug: "customer-ic-check", title: "Customer IC Check", description: "Jobsheets with a missing or invalid Customer Code (IC number).", icon: IdCard, color: "text-red-600 bg-red-500/10", category: "Repairs" },
