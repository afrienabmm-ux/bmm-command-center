...
import type { MechanicCommitmentSummary } from "@/lib/mechanic-commitment-actions";
import { branchLabel, type BranchSelection } from "@/lib/branch";
      ...
      <div className="px-5 py-4 border-b border-neutral-200 flex items-center justify-between flex-wrap gap-3">
        <div>
          <p className="text-sm font-semibold text-neutral-900 flex items-center gap-1.5">
            <Target size={15} className="text-indigo-500" /> Mechanic Commitment — this week
          </p>
