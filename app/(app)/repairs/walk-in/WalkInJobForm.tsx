          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className={isScan ? "text-xs text-white/80 mt-0.5 mb-3" : "text-xs text-neutral-500 mt-0.5 mb-3"}>
                Upload a clear JPG/PNG photo or a PDF of the paper jobsheet — it'll fill in the boxes below for you to check before saving.
              </p>
              <input
                ref={fileInputRef}
                type="file"
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Customer's IC number, e.g. 900101-10-1234"
              className="w-full bg-neutral-50 border border-neutral-200 rounded-lg px-3.5 py-2.5 text-sm text-neutral-800 focus:outline-none focus:border-red-500/50"
            />
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-neutral-50 border border-neutral-200 rounded-lg px-3.5 py-2.5 text-sm text-neutral-800 focus:outline-none focus:border-red-500/50"
            />
            <p className="text-[11px] text-neutral-400 mt-1">Matches this visit to their e-service card, even if the name is spelled differently.</p>
          </div>
